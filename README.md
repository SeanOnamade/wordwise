...
### Smart Review (AI Summary) ✨
Click the ✨ Sparkles button to receive higher-order feedback generated by GPT-4o:

- **Writing Metrics**: Get scored feedback (0-100) on:
  - **Clarity**: How easily your ideas flow
...
- **Issue Detection**: AI identifies problems missed by grammar checkers:
